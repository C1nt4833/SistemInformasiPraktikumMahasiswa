...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!empty($nama)) {
        $stmt = $conn->prepare("INSERT INTO asisten_dosen (user_id, koordinator_id, nama, email, no_hp) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("iisss", $user_id, $koordinator_id, $nama, $email, $no_hp);
                    ...
                    <div class="form-group">
                        ...
                        <select id="user_id" name="user_id">
                            ...
                            <?php while ($u = $users->fetch_assoc()): ?>
                                <option value="<?php echo $u['id']; ?>"><?php echo htmlspecialchars($u['nama'] . ' (' . $u['email'] . ')'); ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>
